...
try {
	...
	//執行sql指令
	$sql = "UPDATE member SET mem_name=:mem_name, mem_tel=:mem_tel, mem_img=:mem_img, mem_psw=:mem_psw, mem_email=:mem_email
	WHERE mem_id = :mem_id";
	...
	$meminfo = ["mem_id"=> $_POST["mem_id"],"mem_email"=> $_POST["mem_email"],"mem_name"=> $_POST["mem_name"],"mem_img"=> $fileName];
